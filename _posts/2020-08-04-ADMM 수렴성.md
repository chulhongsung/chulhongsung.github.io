...
위의 부등식의 결과, 무한합이 bounded되며 더해지는 항은 $0$ 이상이므로 무한합은 수렴해야한다.  무한합이 수렴하기 위해서는 더해지는 항이 $0$으로 수렴해야한다. $\left( \|r^{k+1}\|_2^2 + \|B(z^{k+1} - z^k)\|_2^2 \right) \rightarrow 0$ as $k \rightarrow 0$이어야 한다. 즉,  $r^k\rightarrow 0$ 그리고 $B(z^{k+1} - z^k) \rightarrow 0$이다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY5MDMzODYzMiw5ODM4NjI2NTYsMTc5OT
Y4NTg4OSwxNzY1OTMzNjQ0LDM4NTY1Mzg1MCw1NTM3ODI5NzQs
LTExODM3MzM3MiwtMTUyMjUzODUxOCwtMTU2MzA0Mzk0OSwxMj
A4MTkwOTQ1LDEzOTY0NzU1NTEsLTE2NDUxNjQ0NzksMTMwOTY3
OTAwNyw5MjA4ODIxODUsNTg3OTI1MjkxLDEzNzkzNjIxMzMsMT
E1MjYzMTc3MSwtMTc2MzEzMTQyMV19
-->