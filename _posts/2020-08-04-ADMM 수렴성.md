...
=& \rho \| r^{k+1}\|_2^2 -2\rho(B(z^{k+1} - z^k))^\top r^{k+1} + \rho\|(B(z^{k+1} - z^k))\|_2^2 + \rho\|(B(z^{k+1} - z^k))\|_2^2 + 2\rho(B(z^{k+1} - z^k))^\top B(z^k - z^\star)
\end{aligned}
$$

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgxOTgxNDEyNywxMjA4MTkwOTQ1LDEzOT
