...
$$
(p^\star - p^{k+1}) + (p^{k+1} - p^\star) \leq (y^\star - y^{k+1})^\top r^{k+1} + \rho(B(z^{k+1} - z^k))^\top r^{k+1} - \rho(B(z^{k+1} - z^k))^\top B(z^{k+1} - z^\star)
$$



<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU0OTcwNzg0NSw5MjA4ODIxODUsNTg3OT
