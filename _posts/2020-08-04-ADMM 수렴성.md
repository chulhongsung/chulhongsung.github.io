...
$$
\begin{aligned}
p^\star + y^{\star\top}(Ax^\star - Bz^\star - c) &\leq p^{k+1} +  y^{\star\top}\underbrace{(Ax^{k+1} - Bz^{k+1} - c)}_{r^{k+1}}\\
p^\star &\leq p^{k+1} + y^{\star\top}r^{k+1}\end{aligned}
$$
$$
V^k = (1/\rho) \| y^k - y^\star\|_2^2 + \rho \|B(z^k - z^\star)\|_2^2\\
$$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ5NTA5NTQzMSwtMTc2MzEzMTQyMV19
-->