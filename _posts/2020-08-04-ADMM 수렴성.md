...
$$
\rho \| r^{k+1}\|_2^2 -2\rho(B(z^{k+1} - z^k))^\top r^{k+1} +2 \rho(B(z^{k+1} - z^k))^\top B(z^{k+1} - z^\star)
$$

$z^{k+1} - z^\star = (z^{k+1} - z^k) + (z^k - z^\star)$을 마지막 항에 대입하자.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM1NTQxNzU5NSwxMjA4MTkwOTQ1LDEzOT
