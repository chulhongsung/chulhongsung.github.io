...
### <span style="color:#D181C0;"> A.1	증명</span>
-----
...
=&\rho\|r^{k+1} - B(z^{k+1} - z^k))\|_2^2+ \rho\|(B(z^{k+1} - z^k))\|_2^2 + 2\rho\underbrace{(B(z^{k+1} - z^k)}_{\left( (z^{k+1} - z^{\star}) - (z^k -z^\star)}\right) )^\top B(z^k - z^\star)
\end{aligned}
$$

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMDU1NTQ4ODcsMTIwODE5MDk0NSwxMz
k2NDc1NTUxLC0xNjQ1MTY0NDc5LDEzMDk2NzkwMDcsOTIwODgy
MTg1LDU4NzkyNTI5MSwxMzc5MzYyMTMzLDExNTI2MzE3NzEsLT
E3NjMxMzE0MjFdfQ==
-->