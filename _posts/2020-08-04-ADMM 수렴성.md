...
$$
p^{k+1} + y^{k+1}(Ax^{k+1} + Bz^{k+1}) - \rho (z^{k+1} -z^k)^\top B^\top Z x^{k+1} \leq p^\star + y^{k+1}(Ax^\star + Bz^\star) - \rho (z^{k+1} -z^k)^\top B^\top Z x^{k+1} 
$$
...
$$
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAzNDQ3Nzg0MCwxMzc5MzYyMTMzLDExNT
