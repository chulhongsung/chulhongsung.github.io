...
=&\rho \| r^{k+1}\|_2^2 -2\rho(B(z^{k+1} - z^k))^\top r^{k+1} + \underbrace{2\rho(B(z^{k+1} - z^k))^\top B(z^{k+1} - z^k )}_{2\\|\|} +2\rho(B(z^{k+1} - z^k))^\top B(z^k - z^\star)
\end{aligned}
$$

<!--stackedit_data:
eyJoaXN0b3J5IjpbNDQ4MjQzNDgwLDEyMDgxOTA5NDUsMTM5Nj
Q3NTU1MSwtMTY0NTE2NDQ3OSwxMzA5Njc5MDA3LDkyMDg4MjE4
NSw1ODc5MjUyOTEsMTM3OTM2MjEzMywxMTUyNjMxNzcxLC0xNz
YzMTMxNDIxXX0=
-->