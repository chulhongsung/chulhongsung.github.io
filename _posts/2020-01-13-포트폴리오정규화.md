...
위의 문제들은 $\hat{\Omega} = R^{\top}R/T$ 행렬에 크게 의존한다. 근데 자산들이 매우 큰 연관성이 있거나($\Sigma$가 _'nealy singular matrix'_) 혹은 자산의 수가 샘플 수보다 클 경우($\hat{\Sigma}$가 _'(nearly) singular matrix'_) 문제가 발생한다. 위와 같은 경우에 $\hat{\Omega}$는 0에 가까운 특잇값(singular value)을 갖는다. 역행렬이 존재하지 않은 경우

<!--stackedit_data:
eyJoaXN0b3J5IjpbNTkzMzc3MTUzLC0xNjAzODg5MzU0LC0xOD
g1NTEzNzQ2LDE1OTc5MjU0MTksLTE1NTY3OTk4OTEsNTI5MDEy
MDUyLC0xNjU4ODYxNjU0LC0yMTMzMzYyNTk3LC0xNDkzMTg2OD
E3LC0xMTMyNjIzNjE2LC0zNzg5NjUyNzAsMTgxMjQ5NjU1Miw1
NzcwNDIyMTIsLTIwNDE4MTM2MTcsLTE1MTg4MzE4NTcsLTEwMD
E5NjQ2NzUsMjEyMjQ4ODEyNywxMTAwODMxMTEwLC0xNjczMjEx
OTUwLDE5OTExMDYxODZdfQ==
-->