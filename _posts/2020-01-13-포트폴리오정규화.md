...
\begin{aligned}
\hat{\beta} &= (R^{\top}R)^{-1}R^{\top}1_{T} \\
&= (\hat{\Sigma}+ \hat{\mu}\hat{\mu}^\top)^{-1}\hat{\mu} \\
&=\frac{\hat{\Sigma}^{-1}\hat{\mu}}{1+\hat{\mu}^{\top}\hat{\Sigma}\hat{\mu}}.
\end{aligned}
$$

$\hat{\beta}$의 원소들의 합이 1이 되도록 scaling을 할 수 있다. 

$$
\frac{\hat{\beta}}{1_{N}^{\top}}
$$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYwNzAzMjY4OSwxNTk3OTI1NDE5LC0xNT
U2Nzk5ODkxLDUyOTAxMjA1MiwtMTY1ODg2MTY1NCwtMjEzMzM2
MjU5NywtMTQ5MzE4NjgxNywtMTEzMjYyMzYxNiwtMzc4OTY1Mj
cwLDE4MTI0OTY1NTIsNTc3MDQyMjEyLC0yMDQxODEzNjE3LC0x
NTE4ODMxODU3LC0xMDAxOTY0Njc1LDIxMjI0ODgxMjcsMTEwMD
