...
위의 문제들은 $\hat{\Omega} = R^{\top}R/T$ 행렬에 크게 의존한다. 근데 자산들이 매우 큰 연관성이 있거나 자산의 수가 샘플 수보다 클 경우에 $\hat{\Omega}$는 _'nealy singular matrix'_ 이다.

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1Njg3OTc0NjAsLTE4ODU1MTM3NDYsMT
