...
일반적인 회귀분석 $y = X\beta + \epsilon$ 형태를 생각해보면 여기서 $\beta$의 OLS 추정치 $\hat{\beta} = (X^{\top}X)^{-1}X^{\top}y$이다. 이 식에서 $y$ 대신에 $1_T$로 바꾸면 같은 형태이다. 
...
다음 장에서 위의 문제들을 해결할 정규화 방법에 대해서 얘기한다. 그 전에 설명에 필요한 notation에 대해서 소개한다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNjc2ODkxMzYsLTExMzkyNDI0NjksLT
E2NzgzNjQ5MDMsNTkzMzc3MTUzLC0xNjAzODg5MzU0LC0xODg1
NTEzNzQ2LDE1OTc5MjU0MTksLTE1NTY3OTk4OTEsNTI5MDEyMD
UyLC0xNjU4ODYxNjU0LC0yMTMzMzYyNTk3LC0xNDkzMTg2ODE3
LC0xMTMyNjIzNjE2LC0zNzg5NjUyNzAsMTgxMjQ5NjU1Miw1Nz
cwNDIyMTIsLTIwNDE4MTM2MTcsLTE1MTg4MzE4NTcsLTEwMDE5
NjQ2NzUsMjEyMjQ4ODEyN119
-->