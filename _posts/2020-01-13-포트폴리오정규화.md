...
여기서 $\hat{\beta}$는 $1_T = R\beta + u$ 회귀분석에서 $\beta$의 OLS 추정치이다.

일반적인 회귀분석 $y = X\beta + \epsilon$ 형태를 생각해보면 여기서 $\beta$의 OLS 추정치 $\hat{\beta} = (X^{\top}X)^{-1}X^{\top}y$이다. 이 식에서 $y$ 대신에 $1_T$로 바꾸면 같은 형태이다. 


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NTY3OTk4OTEsNTI5MDEyMDUyLC0xNj
U4ODYxNjU0LC0yMTMzMzYyNTk3LC0xNDkzMTg2ODE3LC0xMTMy
NjIzNjE2LC0zNzg5NjUyNzAsMTgxMjQ5NjU1Miw1NzcwNDIyMT
IsLTIwNDE4MTM2MTcsLTE1MTg4MzE4NTcsLTEwMDE5NjQ2NzUs
MjEyMjQ4ODEyNywxMTAwODMxMTEwLC0xNjczMjExOTUwLDE5OT
ExMDYxODYsNzM2NzQxODQ1LDEwMDU4NTQzNTcsMTcwODU4NzA4
MSw3MzcwNjIyN119
-->