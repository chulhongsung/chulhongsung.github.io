...
>가능도함수는 말그래도 가능도를 나타내는 함수이다. 그럼 가능도랑 확률이랑 다른 것인가? 확률은 $[0,1]$의 값을 갖지만 가능도는 그렇지 않다. 가능도는 실수값을 그냥 가진다. 우리가 갖고 있는 데이터에 대한 가능도를 나타내는 것이다. 데이터 $X$가 $x$관측됐을 경우, 가능도함수 $L$은 다음과 같이 정의한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjM0MDk2OTk4LDc5MjI3NzExNSwyMDI3Nz
kxODY3LC0xODUwODcwMzE3LC0zOTcxNTQ4MTksLTEwNTA1OTc0
OTIsMTYxNDY2NTk1MCwtNzc2NjAxODgyLDI3NjAzODExMiwxOD
g4NDAwNTM1LDE5NDI0OTE5MzAsMjA2MjI5NDQ0LDc3NTUwMDI4
MCwxNDQxNzE5ODI4LC0xOTAyODcyODkyLC01OTAwMTQ0MTYsND
I4NjI5MjIxLDg0NzIyOTY2OSwxNDY0Nzg4NzYxLC0zNTU4NDk3
ODldfQ==
-->