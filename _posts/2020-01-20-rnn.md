...
예를 들어 처음 들었던 예시를 이용해보겠다. 출력값 $\bf{o}^{(t)}$가 3차원 벡터를 다음과 같이 표현할 수 있다.
 ...
 &= (log~p(\text{나는}|\textbf{h}^{(t)}), log~p(\text{밥을}|\textbf{h}^{(t)}), log~p(\text{먹는다}|\textbf{h}^{(t)}))
\end{aligned}
 $$ 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjQ2MjkzNzEzLDI3NjAzODExMiwxODg4ND
AwNTM1LDE5NDI0OTE5MzAsMjA2MjI5NDQ0LDc3NTUwMDI4MCwx
NDQxNzE5ODI4LC0xOTAyODcyODkyLC01OTAwMTQ0MTYsNDI4Nj
I5MjIxLDg0NzIyOTY2OSwxNDY0Nzg4NzYxLC0zNTU4NDk3ODks
LTIwNjE4NjI2MzUsMTQ2MTA4NDM3NiwzNzcyNDI5NzUsLTk5OD
