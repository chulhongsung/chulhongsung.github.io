...
그렇다면 이제 출력값을 통해 손실함수(loss function)을 계산할 수 있다. 손실함수를 계산하기 위해서 실제 $t$ 시점에서 정답인 $\bf{y}^{(t)}$를 가정하자. $t$ 시점에서의 손실함수를 $L^{(t)}$라고 wj RNN 모델의 손실함수 L은 다음과 같이 정의된다.
...
-----------
<!--stackedit_data:
eyJoaXN0b3J5IjpbODg2MzQ2ODMwLC0xOTAyODcyODkyLC01OT
AwMTQ0MTYsNDI4NjI5MjIxLDg0NzIyOTY2OSwxNDY0Nzg4NzYx
LC0zNTU4NDk3ODksLTIwNjE4NjI2MzUsMTQ2MTA4NDM3NiwzNz
cyNDI5NzUsLTk5ODgwOTU2NSwtMTk0MzMwNzI2NSwxMjIzMjUz
NDc0LDEzNjgxNjQyOTYsMzYzODMzMzY3XX0=
-->