...
>가능도함수(likelihood function)는 통계학에서 가장 많이 쓰이고 중요한 개념 중에 하나이다. 기억이 맞다면 통계학의 아버지라고 불리는 R.A. Fisher가 제안했다는 걸로 알다. 가능도는 확률과는 좀 다르다. 기회가 된다면 더 자세하게 글 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAyMjkyNDI1Niw3OTIyNzcxMTUsMjAyNz
