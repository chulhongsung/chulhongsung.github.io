...
출력값이 이해되기 쉽고 확률처럼 와닿게 하기 위해서는 단계가 하나 더 필요하다. 바로 "softmax" 단계이다. softmax를 통해 출력값들의 합은 $1$이 된다. $i$번째 단어의 로그확률값을 softmax를 통해서 $[0,1]$을 값을 갖는다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI4MDY3NDE2OCw4Mjk5NTQ5NzEsMTg4MD
