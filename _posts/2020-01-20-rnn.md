...
RNN을 번역하면 순환신경망이라고 한다. 무엇이 순환하는건가? 바로 뒤에서 설명할 __"은닉 상태(hidden state)"__ 이 순환한다. RNN에서는 신경망 모델을 통해 나온 출력값이 다시 신경망 모델의 입력값으로 들어가게 된다.
...
-----------
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU2MjEwODg3NSwtNjM1ODIyMTMxLC0xMD
I1ODM2MDc5LDE1Mzc3NzQxMzRdfQ==
-->