...
결국 손실함수는 가중치 행렬$(\textbf{W}, \textbf{U}, \textbf{V})$들과 절편 벡터$(\textbf{b}, \textbf{c})$, 즉 모수들에 대한 식으로 쓰여진다. 그리고 손실함수를 줄이는 거 정답이 나올 가능성을 가장 크게 해주는 가중치행렬과 절편 벡터들을 찾는 것이다. 최대가능도추정법과 연결되는 것이다.


<!--stackedit_data:
eyJoaXN0b3J5IjpbNTg4NzYwMDM4LC01NzE4NTI3MSw2NDk5NT
gzNDMsLTI2MzgxNDE5MSwtMTMzMDIwODYxOCwtMTExMTA4NTUw
MSwtMTY2MjA0ODQzMyw4Mjk5NTQ5NzEsMTg4MDk5OTEyOSwtMT
