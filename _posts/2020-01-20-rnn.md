...
그렇다면 이제 출력값을 통해 손실함수(loss function)을 계산할 수 있다. 손실함수를 계산하기 위해서 실제 $t$ 시점에서 정답인 $\bf{y}^{(t)}$를 가정하자. $t$ 시점에서의 손실함수를 $L^{(t)}$라고 정  
### <span style="color:#00ADB5;"> 흠 </span>
-----------
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NTI4NTg4MjEsLTE5MDI4NzI4OTIsLT
U5MDAxNDQxNiw0Mjg2MjkyMjEsODQ3MjI5NjY5LDE0NjQ3ODg3
NjEsLTM1NTg0OTc4OSwtMjA2MTg2MjYzNSwxNDYxMDg0Mzc2LD
M3NzI0Mjk3NSwtOTk4ODA5NTY1LC0xOTQzMzA3MjY1LDEyMjMy
NTM0NzQsMTM2ODE2NDI5NiwzNjM4MzMzNjddfQ==
-->