...
- 밑바닥부터 시작하는 딥러닝2, 사이토 고키, 한빛미디어.

- Deep Learning, Ian Goodfellow et al., MIT Press, [Book website](https://www.deeplearningbook.org/).

- Dive into Deep Learning, Zhang et al., [Book website](https://d2l.ai/).

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg5NzM3NTE4MiwtMTMzOTUzNDk3NywtND
