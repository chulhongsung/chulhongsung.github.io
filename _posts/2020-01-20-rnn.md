...
위의 가능도함수는 일반적으로 확률밀도함수(PDF)ㄷ의 곱으로 나타내는데 $log$를 취하면 확률밀도함수들의 합으로 표현되고 로그가능도함수를 많이 사용한다. 중요한 것은 가능도를 최대화하는 것이다. 근데 일반적으로 기계학습 분야에서는 최소화문제로 최적화를 한다. 따라서 음의 로그가능도함수(negative log likelihood)를 최소화하는 문제로 생각한다. 결국 가능도를 최대화하는 것은 똑같다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTExOTc5MTY5LC0yMDM3MTU1NTk3LDc5Mj
I3NzExNSwyMDI3NzkxODY3LC0xODUwODcwMzE3LC0zOTcxNTQ4
MTksLTEwNTA1OTc0OTIsMTYxNDY2NTk1MCwtNzc2NjAxODgyLD
I3NjAzODExMiwxODg4NDAwNTM1LDE5NDI0OTE5MzAsMjA2MjI5
NDQ0LDc3NTUwMDI4MCwxNDQxNzE5ODI4LC0xOTAyODcyODkyLC
01OTAwMTQ0MTYsNDI4NjI5MjIxLDg0NzIyOTY2OSwxNDY0Nzg4
NzYxXX0=
-->