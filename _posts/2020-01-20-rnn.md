...
결국 손실함수는 가중치 행렬$(\textbf{W}, \textbf{U}, \textbf{V})$들과 절편 벡터$(\textbf{b}, \textbf{c})$, 즉 모수들에 대한 식으로 쓰여진다. 그리고 정답이 나올 가능성을 가장 크게 해주는 가중치행렬과 절편 벡터들을 찾는 것이다. 결국은 최대가능도추정법과 연결되는 거
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNzY4ODE2MDksODI5OTU0OTcxLDE4OD
