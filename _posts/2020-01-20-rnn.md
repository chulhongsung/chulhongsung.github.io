...
학습을 위해서는 한 단계를 더 거쳐야한다. 바로 "softmax" 단계이다. 이 과정을 통해 위에서 언급한 정규화(normalized)가 되고 더 확률의 개념과 가까워진다. $i$번째 단어의 로그확률값을 softmax를 통해서 다음과 같이 

$$
softmax(o^{(t)}_i) = \frac{exp(o^{(t)}_i)}{\sum_{j=1}^{n}exp(o^{(t)}_j)}
$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTQwNjg2MTk3LC0xODUwODcwMzE3LC0zOT
cxNTQ4MTksLTEwNTA1OTc0OTIsMTYxNDY2NTk1MCwtNzc2NjAx
ODgyLDI3NjAzODExMiwxODg4NDAwNTM1LDE5NDI0OTE5MzAsMj
A2MjI5NDQ0LDc3NTUwMDI4MCwxNDQxNzE5ODI4LC0xOTAyODcy
ODkyLC01OTAwMTQ0MTYsNDI4NjI5MjIxLDg0NzIyOTY2OSwxND
Y0Nzg4NzYxLC0zNTU4NDk3ODksLTIwNjE4NjI2MzUsMTQ2MTA4
NDM3Nl19
-->