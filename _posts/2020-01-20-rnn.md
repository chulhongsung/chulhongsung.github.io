...
그렇다면 이제 출력값을 통해 손실함수(loss function)을 계산할 수 있다. 손실함수를 계산하기 위해서 실제 $t$ 시점에서 정답인 $\bf{y}^{(t)}$를 가정하자. $t$ 시점에서의 손실함수를 $L^{(t)}$라고 정의하고 오차제곱합(squared error)이라고 가정하자. 그렇다면 RNN 모델의 총 손실함수 L은 다음과 같이 정의된다.
...
-----------
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgzMjQ1NDY3MywxNDQxNzE5ODI4LC0xOT
AyODcyODkyLC01OTAwMTQ0MTYsNDI4NjI5MjIxLDg0NzIyOTY2
OSwxNDY0Nzg4NzYxLC0zNTU4NDk3ODksLTIwNjE4NjI2MzUsMT
Q2MTA4NDM3NiwzNzcyNDI5NzUsLTk5ODgwOTU2NSwtMTk0MzMw
NzI2NSwxMjIzMjUzNDc0LDEzNjgxNjQyOTYsMzYzODMzMzY3XX
0=
-->