...
위의 가능도함수는 일반적으로 확률밀도함수(PDF)들의 곱으로 나타내는데 $log$를 취하면 확률밀도함수들의 합으로 표현되기 때문에 로그가능도함수를 많이 사용한다. 중요한 것은 가능도를 최대화하는 것인데 $log$도 단조증가하는 함수이기 때문에 일관성은 유지된다. 근데 일반적으로 기계학습 분야에서는 최소화 문제로 최적화를 한다. 따라서 음의 로그가능도함수(negative log likelihood)를 최소화한다. 결구 가능도를 최대화하는 것이다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzEyODIyMjg1LDE4ODA5OTkxMjksLTE5OD
AxMzYzODUsMTA1OTk4NDQ4MCwtMjAzNzE1NTU5Nyw3OTIyNzcx
MTUsMjAyNzc5MTg2NywtMTg1MDg3MDMxNywtMzk3MTU0ODE5LC
0xMDUwNTk3NDkyLDE2MTQ2NjU5NTAsLTc3NjYwMTg4MiwyNzYw
MzgxMTIsMTg4ODQwMDUzNSwxOTQyNDkxOTMwLDIwNjIyOTQ0NC
w3NzU1MDAyODAsMTQ0MTcxOTgyOCwtMTkwMjg3Mjg5MiwtNTkw
MDE0NDE2XX0=
-->