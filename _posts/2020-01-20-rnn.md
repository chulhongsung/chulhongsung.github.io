...
학습을 위해서는 한 단계를 더 거쳐야한다. 바로 "softmax" 단계이다. 이 과정을 통해 위에서 언급한 normalized가 된다고 생각할 수 있다. softmax는 다음과 같다.

$$
softmax(\textbf{o}^{(t)}) = \frac{exp^{\textbf{o}^{(t)}}}{}
$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NzQ2MjQ3NzcsLTE4NTA4NzAzMTcsLT
