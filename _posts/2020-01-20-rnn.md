...
RNN을 번역하면 순환신경망이라고 한다. 그럼 무엇이 순환하는건가?라고 생각할 수 있는데 신경망 모델을 통해 나온 출력값이 다시 신경망 모델의 입력값으로 들어가서
...
-----------
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzAxODgyMzUwLC02MzU4MjIxMzEsLTEwMj
U4MzYwNzksMTUzNzc3NDEzNF19
-->