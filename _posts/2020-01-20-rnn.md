...
위의 가능도함수는 일반적으로 확률밀도함수(PDF)의 곱으로 나타내는데 $log$를 취하면 합으로 표현되기 때문에 로그가능도함수를 많이 사용한다. 그리고 중요한 것은 가능도를 최대화하는 것이다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MTI5OTk1NTIsLTIwMzcxNTU1OTcsNz
