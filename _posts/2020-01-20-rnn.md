...
$$
\begin{aligned}
L(\textbf{W}, \textbf{U}, \textbf{V}, \textbf{b}, \textbf{c}) &=\\
 logp(\text{긍정, 나는, 밥을, 먹는다}; \textbf{W}, \textbf{U}, \textbf{V}, \textbf{b}, \textbf{c}) \approx log\hat{y}^{(3)}_1
\end{aligned}
$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMjMwODM5MzgsNjQ5OTU4MzQzLC0yNj
