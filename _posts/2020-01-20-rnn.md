...
정확하게 확률 한 단계를 더 거쳐야한다. 바로 "softmax" 단계이다. 이 과정을 통해 위에서 언급한 정규화(normalized)가 되고 더 확률의 개념과 가까워진다. $i$번째 단어의 로그확률값을 softmax를 통해서 $[0,1]$을 값을 갖는다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMzNjE1OTUzMCw4Mjk5NTQ5NzEsMTg4MD
