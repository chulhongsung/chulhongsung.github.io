...
먼저 왼쪽 그림을 보면 입력값 $x$가 모델로 들어가서 연산을 통해 $h$가 되는데 $h$는 다시 모델로 들어가도록 설계가 되어있는 것을 확인할 수 있다. 개인적으로 오른쪽에 있는 "Unfold 그림"을 더 선호한다. 신경망을 펼 
...
-----------
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMTA5NjAxODFdfQ==
-->