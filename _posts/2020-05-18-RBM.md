...
----
이번에 제한된 볼츠만 머신에 대해서 공부해보았는데 제한된 볼츠만 머신도 많은 발전을 해왔다. 그 중 하나로 Wasserstein Distance를 이용한 제한된 볼츠만 머신도 있다. 그리고 최근에는 제한된 볼츠만 머신을 이용해 임베딩을 하는 기법도 많이 나오고 있으니 딥러닝을 공부하는 사람들에게는 좋은 공부거리가 될 것 같다.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5OTUyNDU5MCwtMTU2NzM2NzExNSwtMT
