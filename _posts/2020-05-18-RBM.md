...
위에서 언급된 $Z$에 대한 식은 사라지고 뒤에 익숙한 항이 하나 생겼다. 바로 $F_\theta$의 미분값의 기댓값이다. 여기서 log-likelihood를 n으로 나누더라도 최대화하는 방향은 똑같으므로 다음의 식을 사용하도록 한다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQwNDUyMzA5MywtMTgwMTAxMDkyOSwtMT
