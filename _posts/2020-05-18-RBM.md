...
위와 같은 방법으로 학습하는 방법을 'Constrastive Divergence Algorithm'이라고 한다. 그리고 깁스 샘플링을 n 번 하면 'n-CD'라고 하는데 1-CD만 하더라도 충분하다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcwMTg0ODc1NywtMTU2NzM2NzExNSwtMT
