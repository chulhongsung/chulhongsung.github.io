...
$$
\begin{aligned}
\frac{\partial \log p_{\theta}({\bf x})}{\partial b_j} &= \frac{1}{n}\sum_{i=1}^n x_j - \sum_{\tilde{\bf x}}p_{\theta}(\tilde{\bf x})\tilde{x}_j, \\
...
$$
\begin{aligned}
b_j^{(m+1)} &= b_j^{(m)} + \alpha\left( \frac{1}{n}\sum_{i=1}^n x_j - \sum_{\tilde{\bf x}}p_{\theta}(\tilde{\bf x})\tilde{x}_j\right), \\
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NTg5NjI3MDMsMTY0ODA0NzAsLTY2NT
UyMTU4NSwtMTgwMTAxMDkyOSwtMTk5MzMwMzE4Miw4NzE2MzQ2
MzAsLTEzOTIyNjE2OTAsLTE1NjczNjcxMTUsLTE5MzE5MDk2OC
w5MzQ5ODE5MzksMTQzODg4NzcwMywtODg5NDk1NjY0LDYzNzg4
Njc4MiwxMjc1MzkwNTU5LC0yNTU1NTQ5NTEsMTYzMDI1MzQ5NC
wtNTI4NTAwMTU2LC0zMTQ5MTcyNTRdfQ==
-->