...
RBM 학습을 위한 샘플링 방법으로는 'Gibbs sampling(깁스 샘플링)'을 사용한다. 깁스 샘플링은 MCMC 방법 중 하나로 베이지안 통계학을 공부했거나 최적화쪽을 공부하다 보면 자주 등장하는데 자세한 내용은 다루지 않도록 하겠다. 

깁스 샘플링은 매우 간편하고 매우 강력한 샘플링 방법이다.



<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3OTE0ODMyOTMsNjM3ODg2NzgyLDEyNz
