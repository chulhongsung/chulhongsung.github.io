...
RBM 학습을 위한 샘플링 방법으로는 'Gibbs sampling(깁스 샘플링)'을 사용한다. 깁스 샘플링은 MCMC 방법 중 하나로 매우 간편하고 유용한 샘플링 방법이다.

RBM에서 왜 깁스 샘플링을 사용하는가 하면 


<!--stackedit_data:
eyJoaXN0b3J5IjpbOTIxMDc3NTQ0LC04ODk0OTU2NjQsNjM3OD
g2NzgyLDEyNzUzOTA1NTksLTI1NTU1NDk1MSwxNjMwMjUzNDk0
LC01Mjg1MDAxNTYsLTMxNDkxNzI1NF19
-->