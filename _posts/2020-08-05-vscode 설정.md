...
최근까지 python editor로 spyder를 계속 사용하다가 vscode의 감성에 반해 갈아탔다. vscode는 거의 모든 컴퓨터 언어를 다루다보니 python extension을 설치하고 최적화를 위한 extension도 필요하다. 새 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzOTQzNjUxOTddfQ==
-->