...
하지만 $\hat{\beta}_{ridge}$처럼 $(R^{\top}R)$에 $\rho$만큼 대각성분에 더한다면 역행렬을 구할 수 있다. 그 이유는 $R^\top R$는 알다시피 대칭행렬이고 Semi-positive definite 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgwNTg1NzU4LC0xOTA4ODU4NTI2LDM3Mj
