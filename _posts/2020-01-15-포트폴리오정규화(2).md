...
$(\hat{\lambda}_j, \hat{u}_j, \hat{v}_j), j = 1,\dots,N$을 singular system이라고 하자. 보통은 $R$의 singular system이라고 하면 다음을 만족한다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIxNDMxOTIwOSw2MTgyNDQ3NTEsLTY0Mz
