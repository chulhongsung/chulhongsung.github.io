...
하지만 $\hat{\beta}_{ridge}$처럼 $(R^{\top}R)$에 $\rho$만큼 대각성분에 더한다면 역행렬을 구할 수 있다. 그 이유는 $R^\top R$는 알다시피 대칭행렬이고 positive-semi definite 행렬이다. 대각성분에 $\rho > 0$를 더해주면 positive definite 행렬이 된다. 즉, 역행렬을 가지게 된다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDY4NDUyNzkzLC0xOTA4ODU4NTI2LDM3Mj
YxODAsLTE2NTEyNzU3NSwyMDU1OTY3ODQ2LDMzNTkyMDI3Nywt
MTk4ODk3NDEzNSwxMzM4NzYxNzIyLDIwNDcyMDg1MDQsLTUzNT
E2OTA5OSwtNTY4MTkyODgwLDE3NDkzMjQ4ODYsMTMzNDM5NTAx
OSwtMjAyODYyNTE4OCwtMTQyNDI1NzE2MiwtOTM2MDEwMTk2LC
04MTUyOTk0OTMsLTc1NTQwOTQ0MSwtMTQ2ODAyMTIxMiwxNDEz
NDY0MjA4XX0=
-->