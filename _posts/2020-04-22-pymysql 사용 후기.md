...
## <span style="color:#00ADB5;"> 3. Terminal에서 argumnet $\textsf{pd.to\_sql(table\_name, conn)}$으로는 $\textsf{DataFrame}$이 DB에 올라가지지 않는다.</span>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI3NzY3NDcwOCwtOTg0NjY5OTQ0LDU2Nz
