...
```
위와 같이 --user 10 15처럼  여러개를 넣을 경우에는 인식 못하고 에러가 발생했는데 $\textsf{argparse}$ 사용법을 [Stack Overflow](https://stackoverflow.com/questions/15753701/how-can-i-pass-a-list-as-a-command-line-argument-with-argparse)에서 아주 좋은 예시를 보여줘서 쉽게 할 수 있었습니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzExOTUzMDM4LC05ODQ2Njk5NDQsNTY3MD
