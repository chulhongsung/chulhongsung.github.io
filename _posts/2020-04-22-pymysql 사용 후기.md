...
```
 ...
 $\textsf{argparse}$ 패키지를 처음 사용하다보니 모르는 것이 많았는데 [Stack Overflow](https://stackoverflow.com/questions/15753701/how-can-i-pass-a-list-as-a-command-line-argument-with-argparse)에서 아주 좋은 예시를 보여줘서 쉽게 할 수 있었습니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkzMTgzMjUwNiwtOTg0NjY5OTQ0LDU2Nz
