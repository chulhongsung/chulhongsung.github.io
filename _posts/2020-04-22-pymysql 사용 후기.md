...
```
$\textsf{argparse}$ 패키지를 처음 사용하다보니 모르는 것이 많았는데위와 같이 --user 10 15처럼 argument에 여러개를 넣을 경우에는 인식 못하고 에러가 발생했는데 

 [Stack Overflow](https://stackoverflow.com/questions/15753701/how-can-i-pass-a-list-as-a-command-line-argument-with-argparse)에서 아주 좋은 예시를 보여줘서 쉽게 할 수 있었습니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg4Njc0ODUzMSwtOTg0NjY5OTQ0LDU2Nz
AwNDAwMywxNjk1NDg4NDU4LC0xMTY3NjQ5MTcsLTIwMjA4OTYw
MTAsMzI3OTg4NzMwLC0yODExNzg2MTQsLTI4MTE3ODYxNCw0OT
YyMjU4MzIsLTM4Mjk5MzQxNSw0NTYzNTk0NjYsLTExMzI1NDI4
MSwtMTM1MzE4MDQxMywxMDA1MzAxODI5LDIxNDY1NTg3OTEsOT
UxNjgyOTk3LDEzMDM3OTg2MzIsLTE5MzIzNTk4MzQsLTM0ODk3
Nzc5OF19
-->