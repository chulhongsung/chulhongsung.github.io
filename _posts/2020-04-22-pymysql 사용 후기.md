...
## <span style="color:#00ADB5;"> 3. $\textsf{argparse}$ 패키지와 SQL 쿼리  $\textsf{pd.to\_sql(table\_name, conn)}$으로는 $\textsf{DataFrame}$이 DB에 올라가지지 않는다.</span>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMDg5NjMzODAsLTk4NDY2OTk0NCw1Nj
