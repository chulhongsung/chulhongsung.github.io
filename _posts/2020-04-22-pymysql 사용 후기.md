...
여기까지가 제가 정리한 오류와 해결법이었습니다. 파이썬을 잘 모르다보니 쉽게할 수 있는 것도 좀 돌아서 해결한 것도 있습니다. 그래도 이번에 프로젝트를 하면서 효율적이지 못하지만 해결을 했다는 것에 의미를 두고 효율성은 차차 생각해볼 생각입니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI0NTc5MjA5OSwtOTg0NjY5OTQ0LDU2Nz
