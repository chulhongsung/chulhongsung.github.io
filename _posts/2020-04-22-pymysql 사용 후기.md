...
위와 같이 테이블의 data type을 정의했으면 다음의 코드로 table을 생성하면 됩니다.
```python
conn = pymysql.connect(host='xxx.xx.xx.xxx', user='id', password='password',
                        db='db_name', charset='utf8') 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI2ODAxOTU3NiwtMTE2NzY0OTE3LC0yMD
IwODk2MDEwLDMyNzk4ODczMCwtMjgxMTc4NjE0LC0yODExNzg2
MTQsNDk2MjI1ODMyLC0zODI5OTM0MTUsNDU2MzU5NDY2LC0xMT
