...
Variational inference에서의 위와 같은 문제를 해결하는 것이 큰 숙제가 아닐까 싶다. 그리고 KL-divergence를 계산하는 것도 실제 문제에서는 쉽지가 않다. 추후에는 이러
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMxMDM5Mzc3OSwxNzkxNTE3NjgxLC0xND
