...
위의 그림에서 2번째 그림을 보면 KL-divergence가 확 줄어들 것이다. $p(X)$는 쌍봉이지만 우리가 구한 최적의 $q(X)$는 단봉이다. 이러한 현상도 식을 통해 알 수 있는데 $p(X)$가 어떤 값을 가지던 $q(X) \rightarrow 0$이면 $log\frac{q(X)}{p(X)}$값은 작아지게 되고 KL-divergence도 매우 작아지게 된다. 따라서 위의 혀
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjE5NDExMTk4LDE3OTE1MTc2ODEsLTE0NT
YwMzU1ODYsNDU1NjkzMTM5LDE4MDE2MDYzNCwtMTAxMTY2OTU4
NiwxNzg2MDExODEwLDk0NTU3ODQ2MiwtMTI1ODM1MDc0NCwxND
k3Mzk2NjQ4LDUyODQ5OTU1NiwtMTI1NzgzODkzMywtMjAxNDgx
OTE2LDg0NTg4ODI1MywxNzMyNjQ3NDcyLDMzMTAzMDUyMSwtNj
QzNTExNzI4LDEzOTkyNTEzMTYsLTEwOTAzNDQ2NDcsMTQ2MjEz
NTMzXX0=
-->