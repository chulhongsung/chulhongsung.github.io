...
Variational inference에서의 위와 같은 문제를 해결하는 것이 큰 숙제가 아닐까 싶다. VAE가 MNIST 데이터를 제외하고 성능이 잘 나오지 않는 것과 연관이 있지 않을까하는 생각도 든다.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI1MjcyNDE0MiwxNzkxNTE3NjgxLC0xND
