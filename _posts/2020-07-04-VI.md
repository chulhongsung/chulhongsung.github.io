...
![왼쪽은 KL(q|p), 오른쪽은 KL(p|q)를 최소화한 경우](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQe2MR-JrDfVbm30i-D6DOchyiXR-eZO6fACg&usqp=CAU){: width="150%" height="150%"}

그 이유는 KL-divergence 식으로 생각해 볼 수 있다.

$$
KL(p|q) = \mathcal{E}_{X~p}

$$

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NjIxMzMxNTMsNDU1NjkzMTM5LDE4MD
