...
![왼쪽은 KL(q|p), 오른쪽은 KL(p|q)를 최소화한 경우](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQe2MR-JrDfVbm30i-D6DOchyiXR-eZO6fACg&usqp=CAU){: width="100%" height="100%"}

<center>

그 이유는 쉽게 설명하면 이렇다. KL-divergence는 두 분포간의 서포트가 같아야한다. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NjgzODk4NzIsNDU1NjkzMTM5LDE4MD
