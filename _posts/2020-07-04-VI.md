...
> 위에서 $\mathcal{L}(q)$와 같이 함수를 인자로 받는 함수를 범함수(functional)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY0NDQ1NzEsMzMxMDMwNTIxLC02NDM1MT
E3MjgsMTM5OTI1MTMxNiwtMTA5MDM0NDY0NywxNDYyMTM1MzMs
LTgzOTU3NjQ4OCwtMjA4NjYwNDI0NywxNDkzODgwMDk2LDUwMz
