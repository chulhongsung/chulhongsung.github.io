...
<div style="text-align: center;"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQe2MR-JrDfVbm30i-D6DOchyiXR-eZO6fACg&usqp=CAU" width="100%"></div>
...
위의 KL-divergence를 줄이기 위해서는 $p(X)$가 $q(X)$를 dominate하는 분포여야한다. 즉, $q(X) > 0$이면 $p(X)>0$이다.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMTEwNzI4NzYsMTc5MTUxNzY4MSwtMT
