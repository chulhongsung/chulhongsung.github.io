...
<span style="color:#DAF7A6;"> covariance matrix의 추정에서 생기는 오차를 줄이고자 사용하는 _정규화(regularization)_방법<span>을  소개한다.  그리고 기본적인 포트폴리오 이론도 앞에서 설명한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NjA1OTE0MTAsLTk4ODQ3MDcyLDIwMT
Q1MDI2MjQsLTEwOTY1MDcxMTIsMTYxOTM2MTY5OCwxMzQ2NjE3
NDddfQ==
-->