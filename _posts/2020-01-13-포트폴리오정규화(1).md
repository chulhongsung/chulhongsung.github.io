...
--------------
이 논문은 기존의 Markowitz(mean-variance) 모델에서 covariance matrix의 추정에서 생기는 오차를 줄이고자 사용하는<span style="color:#DAF7A6;"> _정규화(regularization)_ <span>방법을 소개한다.  그리고 기본적인 포트폴리오 이론도 앞에서 설명한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNDYwMzU2MjIsLTEwOTY1MDcxMTIsMT
YxOTM2MTY5OCwxMzQ2NjE3NDddfQ==
-->